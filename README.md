...
Download the latest `.deb` package from [Releases](https://github.com/wuji-technology/wuji-studio/releases), then install:
...
Launch from the application menu, or run from the terminal:
